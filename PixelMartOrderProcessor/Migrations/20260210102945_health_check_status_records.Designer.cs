...
namespace PixelMartOrderProcessor.Migrations
{
    ...
    [Migration("20260210102945_health_check_status_records")]
    partial class health_check_status_records
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Shared.Models.WorkerHealthStatus", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("LastCheckTime");

                    b.HasIndex("WorkerName")
                        .IsUnique();

                    b.ToTable("worker_health_status");
                });
